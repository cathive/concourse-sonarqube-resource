...
- name: build-and-analyze
  ...
  - put: code-analysis
    params:
      ...
      # Assuming one wants to use version not in sonar.properties but from a different file 
      # in root of the project named- version, we configure the version file path as below. 
